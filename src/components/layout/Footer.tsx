      ...
      <div className="container-custom py-16">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center gap-2">
                ...
                <span className="text-sm">+52 55 5407 0103</span>
              </li>
            </ul>
          </div>
        ...
        <div className="mt-12 pt-8 border-t border-dark-800 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex gap-4 text-xs text-dark-500">
            <Link to={getLocalizedRoute('privacy', lang)} className="hover:text-dark-300 transition-colors">{t('footer.privacy')}</Link>
            <Link to={getLocalizedRoute('terms', lang)} className="hover:text-dark-300 transition-colors">{t('footer.terms')}</Link>
          </div>
        </div>
      </div>
    </footer>
