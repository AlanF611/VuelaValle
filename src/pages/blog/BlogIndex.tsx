...
export default function BlogIndex() {
  ...
  return (
    <main className="pt-16 lg:pt-20">
      <SEOHead
        title={lang === 'es' ? 'Blog de Parapente en Valle de Bravo | Guías y Consejos | AltaVuela' : 'Paragliding Blog Valle de Bravo | Guides & Tips | AltaVuela'}
        description={lang === 'es' ? 'Guías, consejos y todo lo que necesitas saber sobre el parapente en Valle de Bravo. Blog de AltaVuela.' : 'Guides, tips, and everything you need to know about paragliding in Valle de Bravo. AltaVuela blog.'}
        pathEs="/blog"
        pathEn="/en/blog"
      />
