  ...
  if (submitted) {
    return (
      <main className="pt-16 lg:pt-20">
        <SEOHead
          title={lang === 'es' ? 'Contacto | AltaVuela Parapente Valle de Bravo' : 'Contact Us | AltaVuela Paragliding Valle de Bravo'}
          description={lang === 'es' ? 'Contacta a AltaVuela. Resolvemos tus dudas sobre vuelos en parapente en Valle de Bravo.' : 'Contact AltaVuela. We answer your questions about paragliding in Valle de Bravo.'}
          pathEs="/contacto"
          pathEn="/en/contact"
        />
  ...
  return (
    <main className="pt-16 lg:pt-20">
      ...
      <section className="relative h-[40vh] min-h-[300px] flex items-center justify-center overflow-hidden">
        <img
          src="https://images.unsplash.com/photo-1500534314209-a25ddb2bd429?w=1920"
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-xs text-dark-500">info@altavuela.mx</p>
                  </div>
                </a>
