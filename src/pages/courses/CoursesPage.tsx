...
export default function CoursesPage() {
  ...
  return (
    <main className="pt-16 lg:pt-20">
      <SEOHead
        title={lang === 'es' ? 'Cursos de Parapente en Valle de Bravo | Aprende a Volar | AltaVuela' : 'Paragliding Courses in Valle de Bravo | Learn to Fly | AltaVuela'}
        ...
        ogImage="https://images.unsplash.com/photo-1601987077677-5346c463c08e?w=1200"
      />

      {/* Hero */}
      <section className="relative h-[60vh] min-h-[400px] flex items-center justify-center overflow-hidden">
        <img
          src="https://images.unsplash.com/photo-1601987077677-5346c463c08e?w=1920"
